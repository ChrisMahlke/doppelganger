...
- ⚠️ **Never commit `.env.local` files to version control** - they're already in `.gitignore`
- 🔒 **Restrict API keys** in Google Cloud Console to specific referrers and API targets
...
│  https://demographic-doppelganger-71027948544.us-west1   │
│  .run.app/                                               │
└──────────────────┬──────────────────────────────────────┘
                   │
